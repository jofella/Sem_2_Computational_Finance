...
Test = Eu_Option_BS_MC(S_0, r, sigma, T, M, f)
print(Test)
...
K = 100
M = 10000
no_MC_call_prices = 500 # carefully chose this
...
for i in range(0, no_MC_call_prices, 1):
    V_0__MC_EuCall[i] = Eu_Option_BS_MC(S_0, r, sigma, T, M, f)
    V_0__BS_EuCall[i] = BlackScholes_EuCall(t, S_0, r, sigma, T, K)


# Output terminal message
print(f"The MC price is: {Eu_Option_BS_MC_price} and the \
BS price is: {BlackScholes_EuCall_price}. \
The difference is {BlackScholes_EuCall_price - Eu_Option_BS_MC_price}")
